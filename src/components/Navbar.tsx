      ...
      <div className="fixed top-[calc(max(1rem,env(safe-area-inset-top))-5px)] md:top-[calc(1.5rem+20px)] left-0 right-0 z-[60] flex flex-col items-center pointer-events-none px-4 md:px-0 w-full">
        ...
        <motion.nav
          className={cn(
            ...
            'fixed right-4 top-[calc(max(1rem,env(safe-area-inset-top))-5px)] md:relative md:right-auto md:top-auto z-50 scale-80 origin-top-right md:scale-100 md:origin-center'
          )}
          initial={{ y: -100 }}
          animate={{ y: 0 }}
