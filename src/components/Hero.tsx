    ...
    <section id="home" className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        ...
        <div 
          ...
          className="absolute z-20 w-[71%] md:w-[53%] h-[50vh] translate-y-[5%] md:translate-y-[-6%] md:translate-x-[-2%] pointer-events-auto"
        />
        ...
        <motion.video
          ...
          playsInline
          preload="auto"
          className="w-[102%] md:w-[76%] max-h-[71vh] object-contain mix-blend-screen translate-y-[5%] md:translate-y-[-6%] md:translate-x-[-2%] pointer-events-none"
      ...
      {/* Hero Content */}
      <div className="relative z-40 flex flex-col items-center justify-center w-full h-full mt-12 md:mt-16 pointer-events-none">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: isScrolled ? 0 : 1, y: isScrolled ? -10 : 0 }}
          transition={{ duration: 0.8, delay: isScrolled ? 0 : 0.8, ease: [0.16, 1, 0.3, 1] }}
          className="z-20 mt-[44vh] md:mt-[52vh] mb-4 text-white/75 text-lg md:text-2xl font-light tracking-wide flex flex-col md:flex-row items-center text-center pointer-events-auto"
        >
