...
import { profileMedia } from '../lib/media';

const experiences = [
  {
    id: 1,
    year: '2025.06 - PRESENT',
    company: 'AI 设计工作流与技术探索',
    role: '独立实践 / AIGC 高效工作流构建',
    ...
    <>
      ...
      <AnimatePresence>
        {selectedExp && (
          ...
          >
            <div className="absolute inset-0 bg-black/95" onClick={() => setSelectedExp(null)} />
            ...
            >
              ...
              <p className="text-lg text-white/70 leading-relaxed mb-8">{selectedExp.details}</p>
